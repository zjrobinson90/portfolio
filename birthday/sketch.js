...
function drawLabels() {
  ...
  for (i = 0; i < monthArray.length; i++) {
    text(monthArray[i], gridOffset + getMonth(i) * rectWidth, gridOffset);
  }
}
...
// total number of days up to a certain month
//monthIndex is that month
